...
const workbtn = document.querySelector('.work_all')
console.log(header);
...
setInterval(function(){
    ...
    body.work_all.style.transition= 'opacity 2.5s';
    body.work_all.style.opacity = 1
}, 5000);
...
$(window).on("scroll touchmove", function() {
    ...
    if ($(document).scrollTop() > $("#slogan").position().top -400) {
            $('body').css('background','black');
            $('.slogan_Section .text h3').addClass('sizeUp');
    };

    if ($(document).scrollTop() > $("#profile").position().top -800) {

        $('.slogan_Section .text h3').removeClass('sizeUp');
        console.log($("#profile").position().top -700);
};
    if ($(document).scrollTop() > $("#profile").position().top - 200) {
            $('body').css('background', 'white');
            $('body::-webkit-scrollbar-thumb').css('background','black');
            $('body::-webkit-scrollbar-track').css('background','white');
    };
